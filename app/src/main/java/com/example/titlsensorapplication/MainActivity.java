package com.example.titlsensorapplication;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onStart() {
        ...
        if(mSensorAccelerator != null) {
            mSensorManager.registerListener(this, mSensorAccelerator,
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType) {
            case Sensor.TYPE_ACCELEROMETER:
                mAcceleratorData = sensorEvent.values.clone();
                break;
        ...
        boolean rotationOK = SensorManager.getRotationMatrix(rotationMatrix, null,
                mAcceleratorData, mMagnetometerData);
